...
class Busqueda extends Controller
{
	public function result(){
		...
		$items = $AmaHtml->filter('div.sg-col-4-of-24 > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)');
		$items2 = $AmaHtml->filter('div.s-result-item > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1)');
		$divs = [];
		return count($items2);
		if(count($items) > 0){
		...
		elseif(count($items2) > 0){
			for($i = 0; $i < count($items2); $i++){
				$imgs = $AmaHtml->filter('div.sg-col-20-of-24:nth-child(7) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > a:nth-child(1) > div:nth-child(1) > img:nth-child(1)')->extract(['src']);
				$price1 = $AmaHtml->filter('div.sg-col-20-of-24:nth-child(7) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1) > span:nth-child(1) > span:nth-child(1)')->extract('_text');
				$price2 = $AmaHtml->filter('div.sg-col-4-of-24:nth-child('.($i+1).') > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1) > span:nth-child(1) > span.a-offscreen')->extract('_text');
				$text = $AmaHtml->filter('div.s-result-item:nth-child('.($i+1).') > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > h2:nth-child(1) > a:nth-child(1) > span:nth-child(1)')->extract('_text');
				$hrefs = $AmaHtml->filter('div.s-result-item:nth-child('.($i+1).') > div > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > a:nth-child(1)')->extract(['href']);
				$divs[$i]['img'] = $imgs[0];
		...
		$AmaHtml->clear();
		// return $divs;
		return view('busqueda', compact('divs', 'UrlAmazon'));
	}
}
